...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($numExistRows > 0) {
        ...
        if (($password == $cpassword)) {
            ...
            $sql = "INSERT INTO `users` ( `username`, `password`, `dt`) VALUES ('$username', '$harsh', current_timestamp())";
...
<body>
    ...
    <div class="container my-3">
        ...
        <form action="/loginsystem/signup.php" method="post" class=" my-4 flex-column d-flex align-items-center">
